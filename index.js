...
// countAnimals Time complexity: O(n)
//              Space complexity: O(1)
// countAnimals2 Time complexity: O(1)
//              Space complexity: O(1)
// printTenAnimals Time complexity: O(1)
//              Space complexity: O(1)
// printAnimals Time complexity: O(n)
//              Space complexity: O(1)
// printAnimalsTwice Time complexity: O(n)
//              Space complexity: O(1)
// printAnimalPairs Time complexity: O(n^2)
//              Space complexity: O(1)
// getAnimalPairs Time complexity: O(n^2)
//              Space complexity: O(n^2)
 // getAnimalTriples Time complexity: O(n^3)
//              Space complexity: O(n^3)
// findAnimal Time complexity: O(n)
//              Space complexity: O(1)
